...
int RSAPublicEncrypt
  (unsigned char *output, unsigned int *outputLen, unsigned char *input,
 ...
 */
static int RSAPublicBlock (unsigned char *output, unsigned int *outputLen, unsigned char *input, 
...
/* Raw RSA private-key operation. Output has same length as modulus.
   ...
   Requires input < modulus.
 */
static int RSAPrivateBlock (unsigned char *output, unsigned int *outputLen, unsigned char *input, 
							unsigned int inputLen, R_RSA_PRIVATE_KEY *privateKey)
                                      /* output block */
                          /* length of output block */
                                       /* input block */
